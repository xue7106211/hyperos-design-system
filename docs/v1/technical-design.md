...
├── tina/                   # TinaCMS schema、database、datalayer
...
│   │   └── HyperOSLogo.tsx
│   └── lib/                # source.ts、layout.shared.tsx、shared.ts、tina-docs、cn.ts
...
- `scripts/` — Token 构建脚本（Style Dictionary / Terrazzo）
